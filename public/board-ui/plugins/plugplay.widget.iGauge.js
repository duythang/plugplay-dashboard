(function()
{
    ...
    freeboard.loadWidgetPlugin({
        ...
        "external_scripts" : [
            "/board-ui/plugins/thirdparty/raphael.2.1.0.min.js",
            "/board-ui/plugins/thirdparty/justgage.1.0.1.js"
        ],
        settings: [
            {
                name: "title",
        ...
        {
            newInstanceCallback(new interactiveGaugeWidgetPlugin(settings));
        }
    });
    ...
    var gaugeID = 0;
    var interactiveGaugeWidgetPlugin = function(settings)
    {
        var self = this;
        ...
        this.onCalculatedValueChanged = function (settingName, newValue) {
            ...
            if (!_.isUndefined(gaugeObject)) {
                if (!over) gaugeObject.refresh(newValue);
                lastVal = newValue;
            }
        }
