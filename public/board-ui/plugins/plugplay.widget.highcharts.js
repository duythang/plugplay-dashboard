...
(function() {
	...
	freeboard
		.loadWidgetPlugin({
			...
			"external_scripts": [
				...
				"/board-ui/plugins/thirdparty/highcharts.js",
				"/board-ui/plugins/thirdparty/exporting.js",
	...
	var highchartsTimeseriesWidgetPlugin = function(settings) {
		...
		var Xaxis = "{\"title\":{\"text\" : \"Time\"}, \"type\": \"datetime\", \"floor\":0}";
		var Yaxis = "{\"title\":{\"text\" : \"Values\"}, \"minorTickInterval\":\"auto\", \"floor\":0}";
		...
		function createWidget() {
			...
			var thisWidgetXAxis = JSON.parse(Xaxis);
			var thisWidgetYAxis = JSON.parse(Yaxis);
